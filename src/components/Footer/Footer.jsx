  ...
  return (
    <footer>
      <div className="flex flex-col">
        <div className="flex flex-row bg-[#0b7361] pl-24 max-[700px]:pl-4 max-[700px]:space-x-3 space-x-6">
          ...
          <span className="flex flex-row my-auto">
            <Link>
              <img
                src={instagram}
                alt=""
                className="bg-[#009A80] hover:bg-[#0b7361] hover:opacity-60 rounded-md w-8 h-min mr-7"
              />
            </Link>
            <Link>
              <img
                src={linkedin}
                alt=""
                className="bg-[#009A80] hover:bg-[#0b7361] hover:opacity-60 rounded-md w-8 h-min"
              />
            </Link>
          </span>
        </div>

        <div className="bg-[#009A80] w-full mx-auto max-[700px]:py-4 py-8 pl-24 max-[700px]:pl-4">
          <div>
        ...
        <div className="bg-[#009A80] w-full mx-auto max-[700px]:p-0 max-[700px]:pb-4 pb-8 pl-24 max-[700px]:pl-4">
          ...
          <span className=" flex flex-row text-center items-center justify-center text-white mt-4">
            <p>© Copyright&nbsp;</p>
            <Link to="https://hugg.co.in" className=" font-semibold">
              hugg.co.in&nbsp;
            </Link>
